...
- Target file: Write or update the file `issue_name.prompt.md` in the `./issues` directory where `issue_name` corresponds to the name in the attached file's name if provided or the current branch name otherwise.
